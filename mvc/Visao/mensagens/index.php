...
<header class="nav">
    ...
    <section class="app_chat">
        <header>

            <nav class="app_chat_nav">
                <ul>

                    <li>
                        <button class="app_chat_nav_clip">
                    ...
                    <li>
                        <button class="app_chat_nav_config">
            ...
            <!-- FOTO PERFIL -->
            <figure>
                <img src="<?=  URL_IMG ?>1.jpg">
                <figcaption>  amanda karoline  </figcaption>
            </figure>
          
            
        </header>

        <form action="<?= URL_RAIZ . 'mensagens/'  ?>" method="post" >
            
        <div class="app_chat_mensagem_rementente app_chat_mensagem">

            <ul>
                <li>
                    <p> Olá, tudo bem? <span>9:39 PM</span></p>
                </li>
                 <br>
                 <li>
                    <p> Olá, tudo bem? <span>9:39 PM</span></p>
        ...
        <div class="app_chat_mensagem_destinatario app_chat_mensagem">
            <ul>

                    <li>
                        Ta bom! <span>9:39 PM</span>
                    </li>
                    <br>
                    <li>
                        Ta bom! <span>9:39 PM</span>
        ...
        <footer>
        <div class="app_chat_submit">
                <div class="app_chat_submit_button">
                    <button>
                ...
                <div class="form-group app_chat_submit_form ">
                    <input id="texto" name="texto" type="text" placeholder="Digite uma mensagem"  value="">
                </div>
                <div class="app_chat_submit_button">
                    <button type="submit">
